        ...
        options={{
          ...
          tabBarIcon: ({ color, size, focused }) => (
            <View style={{
              ...
              <MaterialIcons name="people-alt" size={focused ? 26 : 24} color={color} />
            </View>
          ),
